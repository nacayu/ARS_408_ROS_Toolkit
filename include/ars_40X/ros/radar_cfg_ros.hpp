...
class RadarCfgROS {
 public:
  ...
  bool set_rcs_threshold(
    ...
    //new added
  bool set_filter_min_lifetime(
      RadarFilter::Request &req,
      RadarFilter::Response & /*res*/);

  bool set_filter_max_lifetime(
      RadarFilter::Request &req,
      RadarFilter::Response & /*res*/);
...
//建立饼初始化雷达两个配置类
  ...
  //new added
  ros::ServiceServer set_filter_min_lifetime_service_;

  ros::ServiceServer set_filter_max_lifetime_service_;
};
}
