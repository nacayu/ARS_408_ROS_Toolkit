...
namespace radar_filter_cfg{
  typedef union radar_filter_cfg{
    struct{
      ...
      uint64_t FilterCfg_Max_Lifetime1 : 4;
  ...
  class RadarFilterCfg{
    ...
    bool set_filter_min_lifetime(uint64_t min_life_time, bool valid = true);

    bool set_filter_max_lifetime(uint64_t max_life_time, bool valid = true);
